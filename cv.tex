...
\textit{Master of Science in Robotics} \hfill GPA: Coming Soon \\
\textit{Supervisor:} \href{https://guppy.mpe.nus.edu.sg/~mpeangh/}{Prof. Marcelo H. Ang Jr.} \\
\textit{Thesis:} Coming Soon \\
...
\begin{itemize}
    ...
    \item \textbf{Software:} \LaTeX, Git, Linux, Anaconda, ROS Noetic, Docker, Android Studio, OpenBCI, draw.io, Eprime
